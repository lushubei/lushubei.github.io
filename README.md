...
### [View Live Shubei Blog &rarr;](https://lushubei.gjthub.io)  
...
```
$ git clone git@github.com:lushubei/huxblog-boilerplate.git
```
...
- Brand new [Archive](https://lushubei.gjthub.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/lushubei/lushubei.github.io/issues/15) about code wrap.
...
```yml
# Site settings
title: Shubei Blog             # title of your website
SEOTitle: Shubei Blog          # check out docs for more detail
...
sidebar-avatar: /img/*.jpg     # use absolute URL.
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/lushubei/lushubei.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“Shubei Blog”** but I want the title shows in search engine is **“书备的博客 | Shubei Blog”** which is multi-language.
...
Apache License 2.0.
Copyright (c) 2015-2020 lushubei

Shubei Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)

...
### [我的博客在这里 &rarr;](http://lushubei.github.io)
...
* 如果你喜欢我的这个博客模板，请在`lushubei.github.io`这个repository点个赞——右上角**star**一下。
...
好像两个命令都是可以的自动运行修改后的文件的，刷新后可以实时预览。官方文件是建议安装bundler，这样你在本地的效果就跟在github上面是一样的。详情请见这里：https://help.github.com/articles/using-jekyll-with-pages/#installing-jekyll
...
```
# Site settings
title: Shubei Blog             # 你的博客网站标题
SEOTitle: Shubei Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: lushubei     # 你的github账号
weibo_username: lushubei      # 你的微博账号，底部链接会自动更新的。
...
看右边:
![](http://lushubei.github.io/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/*.jpg     #你的大头贴，请使用绝对地址.
```
...
博客支持[Valine](https://valine.js.org/)评论系统。
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/lushubei/lushubei.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Shubei Blog”** 但是我想要在搜索的时候显示 **“书备的博客 | Shubei Blog”** ，这个就需要SEO Title来定义了。
